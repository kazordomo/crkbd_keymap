...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_BASE] = LAYOUT_split_3x6_3(
      ...
      LT(MO(L_MEDIA), KC_DEL),   LT(MO(L_NAV), KC_TAB),  LT(MO(L_SYM), KC_SPC), LT(MO(L_NUM), KC_ENT),  LT(MO(L_MOUSE), KC_BSPC), LT(MO(L_FUNC), KC_ESC)
  ),

  // Numbers
  [L_NUM] = LAYOUT_split_3x6_3(
      KC_AT,    KC_1, KC_2, KC_3, KC_4,  KC_5, KC_6,  KC_7, KC_8, KC_9, KC_0, XXXXXXX,
      XXXXXXX, KC_LBRC, KC_LT, KC_RT, KC_RBRC, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  ...
  [L_SYM] = LAYOUT_split_3x6_3(
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_AMPR, KC_QUOTE,  KC_DQT, KS_SLSH, KC_PIPE, KC_BSLS,
